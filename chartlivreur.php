            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="chartlivreur.php">
                                <i class="fas fa-chart-bar"></i>Charts livreur</a>
                        </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="login.html">PDF livraison</a>
                                </li>
                                <li>
                                    <a href="register.html">PDF livreur</a>
                                </li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-table"></i>livreur</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                              <li>
                                  <a href="afficherlivreur.php">Afficher</a>
                              </li>
                              <li>
                                  <a href="ajoutlivreur.html">Ajouter</a>
                              </li>
                            </ul>
                        </li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-table"></i>livraison</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                              <li>
                                  <a href="afficherlivraison.php">Afficher</a>
                              </li>
                              <li>
                                  <a href="ajoutlivraison.html">Ajouter</a>
                              </li>
                            </ul>
                        </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                              <li>
                                  <a href="tcpdf/pdflivraison.php">PDF livraison</a>
                              </li>
                              <li>
                                  <a href="tcpdf/pdflivreur.php">PDF livreur</a>
                              </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                              <li>
                                  <a href="contact.php">Front livreur</a>
                              </li>
                              <li>
                                  <a href="contact2.php">Front livraison</a>
                              </li>
                            </ul>
                        </li>
                    </ul>
...
<div class="content">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Mariem Ben Arfa</a>
                                        </div>
